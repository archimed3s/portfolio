...
export default class InteractiveControls extends EventEmitter {
	...
	addListeners() {
		...
		this.el.addEventListener('touchstart', this.handlerDown, true);
		this.el.addEventListener('touchmove', this.handlerMove, true);
		this.el.addEventListener('touchend', this.handlerUp, true);
